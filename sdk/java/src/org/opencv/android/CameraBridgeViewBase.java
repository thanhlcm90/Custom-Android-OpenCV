...
public abstract class CameraBridgeViewBase extends SurfaceView implements
	...
	protected boolean				mPortrait		= false;
	...
	/**
	 * Sets the camera index (front or back)
	 * 
	 * @param cameraIndex
	 *            new camera index
	 */
	...
	/**
	 * get the camera index (front or back)
	 * 
	 * @return
	 */
	...
	/**
	 * set camera preview in Portrait mode
	 * 
	 * @param portrait
	 */
	public void setPortraitMode(boolean portrait) {
		mPortrait = portrait;
	}
	...
	protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
		...
		// Portrait mode, don't draw bitmap, setPreviewDisplay is current
		// holder, camera auto draw
		if (!mPortrait) {
			boolean bmpValid = true;
			if (modified != null) {
				try {
					Utils.matToBitmap(modified, mCacheBitmap);
					Log.d(TAG, "Bitmap size: " + mCacheBitmap.getWidth() + "*"
			...
			if (bmpValid && mCacheBitmap != null) {
				...
				if (canvas != null) {
					...
					// rotation bitmap if having landscape mode
					if (mPortrait) {
	...
	// constructor!
	// NOTE: create cache bitmap in Landscape mode, swap FrameWidth and
	// FrameHeight
